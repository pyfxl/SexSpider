...
public class ListFavoriteActivity extends ListActivity implements IListView {
    ...
    public List<ListBean> getLists(int siteId) {
        ...
        return listPresenter.getListsByFavorite();
    }

    @Override
    public void setActionBar() {
        setActionBarTitle(R.string.txt_title_favorite);
    }
    ...
    public void viewOnMethod() {
        List<ListBean> lists = listPresenter.getListsByFavorite();
        setLists(lists);
    }
